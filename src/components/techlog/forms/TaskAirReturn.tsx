    ...
    <div className="flex flex-col h-full relative font-sans">
      ...
      <div className="flex-1 overflow-y-auto pr-2 flex flex-col gap-6 scrollbar-thin scrollbar-thumb-[#444] scrollbar-track-transparent pb-4">
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div>
            <label className="block text-[0.65rem] text-[#8fa0a6] font-bold uppercase tracking-widest mb-2">Arrival Station (Air Return)</label>
            <input 
              type="text" 
