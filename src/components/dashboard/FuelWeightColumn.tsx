...
export default function FuelWeightColumn({ flightData, updateFlightData, calc, handlers }: { flightData: any, updateFlightData: any, calc: any, handlers: any }) {
  ...
  return (
    <div className="flex-[4] flex flex-col h-full overflow-hidden">
      <div className="bg-lido-800 border border-[#333333] rounded-lg p-3 h-full flex flex-col">
        ...
        <div className="flex justify-between items-center mb-2 shrink-0">
          ...
          <button 
            ...
            className={`text-[0.65rem] px-3 py-1 rounded font-bold border transition-colors ${calc.isManual ? 'bg-[#FF9100]/20 text-[#FF9100] border-[#FF9100]' : 'bg-[#00E676]/20 text-[#00E676] border-[#00E676]'}`}
          >
          ...
          <div className="flex-1 grid grid-cols-[1.5fr_1fr_1fr_1.2fr_0.5fr] gap-1 items-center border-b border-dashed border-[#1d2733]">
            <div className="text-xs text-status-teal font-bold flex items-center justify-between pr-2">
              ...
              <select 
                ...
                className="bg-[#1a222a] border border-[#404040] text-[#FF9100] rounded text-[0.65rem] outline-none px-1 py-0.5 w-[50px]"
              >
