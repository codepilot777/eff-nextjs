    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-lido-950 text-slate-300 font-sans p-6">
      ...
      <div className="flex gap-6 w-full max-w-4xl">
        ...
        <div className="flex-1 block">
          <button 
            ...
            className="w-full h-80 flex flex-col items-center justify-center bg-lido-800 border-2 border-[#333333] rounded-xl hover:border-[#00bfa5] hover:bg-lido-800 hover:shadow-[0_0_20px_rgba(0,191,165,0.4)] transition-all group"
          >
      ...
      {showPinModal && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-lido-800 border border-[#333333] rounded-xl p-8 max-w-md w-full shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            <h3 className="text-2xl font-bold text-status-teal mb-2 text-center">Instructor Login</h3>
            <p className="text-text-muted mb-6 text-center text-sm">Enter your Name and IOS PIN (Default: 0564)<br/>Type "admin" to manage all sessions.</p>
            ...
            <form onSubmit={handlePinSubmit} className="flex flex-col gap-4">
              <input
                ...
                className="w-full bg-lido-950 border border-[#404040] rounded-lg p-3 text-white text-center font-bold focus:outline-none focus:border-[#00bfa5] transition-colors"
              ...
              <input
                ...
                className="w-full bg-lido-950 border border-[#404040] rounded-lg p-3 text-white text-center text-xl tracking-[0.5em] focus:outline-none focus:border-[#00bfa5] transition-colors"
                placeholder="••••"
                required
              />
              ...
              <div className="flex gap-3 mt-4">
                <button 
                  ...
                  className="flex-1 py-3 rounded-lg border border-[#404040] text-text-muted hover:bg-[#34495e] hover:text-white transition-colors font-bold"
                >
                  CANCEL
                </button>
                <button 
                  type="submit" 
                  className="flex-1 py-3 rounded-lg bg-[#00bfa5]/20 border border-[#00bfa5] text-status-teal hover:bg-[#00bfa5] hover:text-black transition-colors font-bold"
                >
                  AUTHORIZE
                </button>
              </div>
